        ...
        <div className="container">
          <div className="hero-content animate-fade-in-up" style={{ maxWidth: 700 }}>
            ...
            <div className="hero-actions" style={{ marginTop: '2rem' }}>
              ...
              <Link to="/run" className="btn btn-secondary" style={{ padding: '0.875rem 1.75rem', fontSize: '1.0625rem', borderColor: 'white', color: 'white', background: 'rgba(255,255,255,0.15)' }}>
